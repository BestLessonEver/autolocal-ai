...
import type { SiteTemplateName } from './types'
...
export default function ProfessionalSite({ data, template, mode }: { data: PublicSiteData; template?: SiteTemplateName; mode?: SiteRenderOptions['mode'] }) {
