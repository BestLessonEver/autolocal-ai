...
export default function ManualStartFlow() {
          ...
          <form ref={formRef} onSubmit={submit}>
            {step === 0 && (
              <>
                ...
                <p className={s.hint}>
                  Already have a Google listing?{" "}
                  <Link href={`/start?template=${draft.template}`}>
                    Build your website from it automatically.
                  </Link>
                </p>
              </>
            )}
            {step === 1 && (
              <>
                ...
                <p className={s.intro}>
                  Add your contact details and hours so customers can reach you.
                </p>
                <div className={s.fields}>
                  <label className={m.field}>
                    Business category
